    ...
    def run(self, plan: TestPlan) -> GeneratedSuite:
        ...
        if "math_hub" in target_url or ("pradhansuman.github.io" in target_url and "math" in target_url):
            math_hub_hint = (
                ...
                "  Both of these selectors work to click Chapter 3's nav link:\n"
                "    page.locator('[data-testid=\"nav-ch03\"]')   — preferred\n"
                "    page.locator('a[href=\"#chapter-3\"]')       — also valid\n"
                "  After clicking, verify the section is in viewport:\n"
